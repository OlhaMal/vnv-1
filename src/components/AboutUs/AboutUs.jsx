        ...
        >
          <ul className={scss.preferenceList}>
            ...
            >
              ...
              <p className={scss.cardText}>
                Постійне поліпшення, розширення рівня капіталізації, оптимізація
                топ-менеджерів та створення оптимальних товарних груп та
                відділів забезпечили підприємству визнання на ринку України.
              </p>
            </motion.li>
            <motion.li
              whileHover={{
            ...
            >
              ...
              <p className={scss.cardText}>
                ...
                технічної бази) життєво необхідне для розвитку, тому ми постійно
                працюємо над поліпшенням та разом з тим, відкриті до
                накопичення.
              </p>
            </motion.li>
            <motion.li
